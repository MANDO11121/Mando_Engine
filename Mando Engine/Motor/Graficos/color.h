...
puede ser contruida con valores de 0-1 , 0-255 o Hex
**/
class Color
{
    public:
        ...
        **/
        ...
        /**
        Toma el valor Hex del color 0xRRGGBB
        **/
        Color(int hex);
        virtual ~Color();

        /**Obtiene el valor de Rojo(0-1)**/
        float getR();
        /**Obtiene el valor de Verde(0-1)**/
        float getG();
        /**Obtiene el valor de Azul(0-1)**/
        float getB();

        /**Cambia el valor de Rojo(0-1)**/
        void setR(float r);
        /**Cambia el valor de Verde(0-1)**/
        void setG(float g);
        /**Cambia el valor de Azrl(0-1)**/
        void setB(float b);

        /**Cambia el valor de Rojo(0-255)**/
        void setR(int r);
        /**Cambia el valor de Verde(0-255)**/
        void setG(int g);
        /**Cambia el valor de Azul(0-255)**/
        void setB(int b);

        /**Obtiene un vector float[3] con los valores del color**/
        glm::vec3& getVector();

        char* aCharArray()const;
    protected:
